...
pub fn invert(mat: &Mat4<f32>) -> Mat4<f32> {
    ...
    inv.0[0][0] =  (mat.0[1][1] * mat.0[2][2] * mat.0[3][3]) - (mat.0[1][1] * mat.0[3][2] * mat.0[2][3]) - (mat.0[1][2] * mat.0[2][1] * mat.0[3][3]) + (mat.0[1][2] * mat.0[3][1] * mat.0[2][3]) + (mat.0[1][3] * mat.0[2][1] * mat.0[3][2]) - (mat.0[1][3] * mat.0[3][1] * mat.0[2][2]);
    inv.0[1][0] = -(mat.0[1][0] * mat.0[2][2] * mat.0[3][3]) + (mat.0[1][0] * mat.0[3][2] * mat.0[2][3]) + (mat.0[1][2] * mat.0[2][0] * mat.0[3][3]) - (mat.0[1][2] * mat.0[3][0] * mat.0[2][3]) - (mat.0[1][3] * mat.0[2][0] * mat.0[3][2]) + (mat.0[1][3] * mat.0[3][0] * mat.0[2][2]);
    inv.0[2][0] =  (mat.0[1][0] * mat.0[2][1] * mat.0[3][3]) - (mat.0[1][0] * mat.0[3][1] * mat.0[2][3]) - (mat.0[1][1] * mat.0[2][0] * mat.0[3][3]) + (mat.0[1][1] * mat.0[3][0] * mat.0[2][3]) + (mat.0[1][3] * mat.0[2][0] * mat.0[3][1]) - (mat.0[1][3] * mat.0[3][0] * mat.0[2][1]);
    inv.0[3][0] = -(mat.0[1][0] * mat.0[2][1] * mat.0[3][2]) + (mat.0[1][0] * mat.0[3][1] * mat.0[2][2]) + (mat.0[1][1] * mat.0[2][0] * mat.0[3][2]) - (mat.0[1][1] * mat.0[3][0] * mat.0[2][2]) - (mat.0[1][2] * mat.0[2][0] * mat.0[3][1]) + (mat.0[1][2] * mat.0[3][0] * mat.0[2][1]);

    inv.0[0][1] = -(mat.0[0][1] * mat.0[2][2] * mat.0[3][3]) + (mat.0[0][1] * mat.0[3][2] * mat.0[2][3]) + (mat.0[0][2] * mat.0[2][1] * mat.0[3][3]) - (mat.0[0][2] * mat.0[3][1] * mat.0[2][3]) - (mat.0[0][3] * mat.0[2][1] * mat.0[3][2]) + (mat.0[0][3] * mat.0[3][1] * mat.0[2][2]);
    inv.0[1][1] =  (mat.0[0][0] * mat.0[2][2] * mat.0[3][3]) - (mat.0[0][0] * mat.0[3][2] * mat.0[2][3]) - (mat.0[0][2] * mat.0[2][0] * mat.0[3][3]) + (mat.0[0][2] * mat.0[3][0] * mat.0[2][3]) + (mat.0[0][3] * mat.0[2][0] * mat.0[3][2]) - (mat.0[0][3] * mat.0[3][0] * mat.0[2][2]);
    inv.0[2][1] = -(mat.0[0][0] * mat.0[2][1] * mat.0[3][3]) + (mat.0[0][0] * mat.0[3][1] * mat.0[2][3]) + (mat.0[0][1] * mat.0[2][0] * mat.0[3][3]) - (mat.0[0][1] * mat.0[3][0] * mat.0[2][3]) - (mat.0[0][3] * mat.0[2][0] * mat.0[3][1]) + (mat.0[0][3] * mat.0[3][0] * mat.0[2][1]);
    inv.0[3][1] =  (mat.0[0][0] * mat.0[2][1] * mat.0[3][2]) - (mat.0[0][0] * mat.0[3][1] * mat.0[2][2]) - (mat.0[0][1] * mat.0[2][0] * mat.0[3][2]) + (mat.0[0][1] * mat.0[3][0] * mat.0[2][2]) + (mat.0[0][2] * mat.0[2][0] * mat.0[3][1]) - (mat.0[0][2] * mat.0[3][0] * mat.0[2][1]);

    inv.0[0][2] =  (mat.0[0][1] * mat.0[1][2] * mat.0[3][3]) - (mat.0[0][1] * mat.0[3][2] * mat.0[1][3]) - (mat.0[0][2] * mat.0[1][1] * mat.0[3][3]) + (mat.0[0][2] * mat.0[3][1] * mat.0[1][3]) + (mat.0[0][3] * mat.0[1][1] * mat.0[3][2]) - (mat.0[0][3] * mat.0[3][1] * mat.0[1][2]);
    inv.0[1][2] = -(mat.0[0][0] * mat.0[1][2] * mat.0[3][3]) + (mat.0[0][0] * mat.0[3][2] * mat.0[1][3]) + (mat.0[0][2] * mat.0[1][0] * mat.0[3][3]) - (mat.0[0][2] * mat.0[3][0] * mat.0[1][3]) - (mat.0[0][3] * mat.0[1][0] * mat.0[3][2]) + (mat.0[0][3] * mat.0[3][0] * mat.0[1][2]);
    inv.0[2][2] =  (mat.0[0][0] * mat.0[1][1] * mat.0[3][3]) - (mat.0[0][0] * mat.0[3][1] * mat.0[1][3]) - (mat.0[0][1] * mat.0[1][0] * mat.0[3][3]) + (mat.0[0][1] * mat.0[3][0] * mat.0[1][3]) + (mat.0[0][3] * mat.0[1][0] * mat.0[3][1]) - (mat.0[0][3] * mat.0[3][0] * mat.0[1][1]);
    inv.0[3][2] = -(mat.0[0][0] * mat.0[1][1] * mat.0[3][2]) + (mat.0[0][0] * mat.0[3][1] * mat.0[1][2]) + (mat.0[0][1] * mat.0[1][0] * mat.0[3][2]) - (mat.0[0][1] * mat.0[3][0] * mat.0[1][2]) - (mat.0[0][2] * mat.0[1][0] * mat.0[3][1]) + (mat.0[0][2] * mat.0[3][0] * mat.0[1][1]);

    inv.0[0][3] = -(mat.0[0][1] * mat.0[1][2] * mat.0[2][3]) + (mat.0[0][1] * mat.0[2][2] * mat.0[1][3]) + (mat.0[0][2] * mat.0[1][1] * mat.0[2][3]) - (mat.0[0][2] * mat.0[2][1] * mat.0[1][3]) - (mat.0[0][3] * mat.0[1][1] * mat.0[2][2]) + (mat.0[0][3] * mat.0[2][1] * mat.0[1][2]);
    inv.0[1][3] =  (mat.0[0][0] * mat.0[1][2] * mat.0[2][3]) - (mat.0[0][0] * mat.0[2][2] * mat.0[1][3]) - (mat.0[0][2] * mat.0[1][0] * mat.0[2][3]) + (mat.0[0][2] * mat.0[2][0] * mat.0[1][3]) + (mat.0[0][3] * mat.0[1][0] * mat.0[2][2]) - (mat.0[0][3] * mat.0[2][0] * mat.0[1][2]);
    inv.0[2][3] = -(mat.0[0][0] * mat.0[1][1] * mat.0[2][3]) + (mat.0[0][0] * mat.0[2][1] * mat.0[1][3]) + (mat.0[0][1] * mat.0[1][0] * mat.0[2][3]) - (mat.0[0][1] * mat.0[2][0] * mat.0[1][3]) - (mat.0[0][3] * mat.0[1][0] * mat.0[2][1]) + (mat.0[0][3] * mat.0[2][0] * mat.0[1][1]);
    inv.0[3][3] =  (mat.0[0][0] * mat.0[1][1] * mat.0[2][2]) - (mat.0[0][0] * mat.0[2][1] * mat.0[1][2]) - (mat.0[0][1] * mat.0[1][0] * mat.0[2][2]) + (mat.0[0][1] * mat.0[2][0] * mat.0[1][2]) + (mat.0[0][2] * mat.0[1][0] * mat.0[2][1]) - (mat.0[0][2] * mat.0[2][0] * mat.0[1][1]);

    let determinant = (mat.0[0][0] * inv.0[0][0]) + (mat.0[1][0] * inv.0[0][1]) + (mat.0[2][0] * inv.0[0][2]) + (mat.0[3][0] * inv.0[0][3]);
